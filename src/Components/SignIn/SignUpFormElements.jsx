...
function SignUpFormElements() {
  return (
    <div className=" bg-white sm:h-full h-[100vh] p-10 text-gray rounded w-full ">
      <h2 className="font-bold text-[24px]">Sign up for Influencer Agent</h2>
      ...
      <div className="flex items-center mt-10 mb-10  justify-evenly">
        <div className="w-[40%] bg-accent h-[1px]" />
        <span className="text-[#c2c2c2] mx-8 text-sm">Or</span>
        <div className="w-[40%] bg-accent h-[1px] " />
      </div>
      <div className="mt-5 flex item-center w-full">
        <div className="w-[200px] mr-4">
          <label className="font-bold ">Name</label>
          <input className="bg-[#f3f3f4] p-2 mt-2 rounded-lg" />
        </div>
      ...
      <div className="mt-5 flex flex-col">
        {" "}
        <label className="font-bold ">Business Account</label>
        <div className="flex mt-4">
          <input type={"checkbox"} className="bg-[#f3f3f4]   mr-2" />{" "}
          <span className="text-[12px] text-[#c2c2c2]">
            Creating This Account to Advertize my business
          </span>
        </div>
      </div>{" "}
      <button className="gradient-dark px-10 mb-8 w-full rounded-md py-4 shadow-md  mt-8 font-semibold  text-sm text-white">
        Sign Up
      </button>
      <Link className="mt-4 text-sm underline text-center w-full" to="/sign-in">
